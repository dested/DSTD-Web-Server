...
namespace DefaultNamespace {
    ...
    public class SocketServer :System.Windows.Forms.Form {
        ...
        public string GetHeader(int iTotBytes,string sStatusCode) {
            ...
            sBuffer = sBuffer + "Content-Type: text/plain \r\n";
...
//            SendToBrowser(bSendData, ref mySocket);
        ...
        public class SocketPacket {
            ...
            public byte[] dataBuffer = new byte[15];
        }
        ...
        private void AppendDataToStream(string data)
        {
        ...
        {
            string ds = dataStream.ToString();
            string s=GetHeader("Fuck You".Length, "200");
            s += "Fuck You";
